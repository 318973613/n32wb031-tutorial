...
1. Function description
    ...
    two slave at the same time. After establishment, the received slave data can be sent to the master, 
...
3. Instructions
    ...
    2. LED1/LED2 indicates the connection status, and lights up when Bluetooth is connected.
        ...
        4. Download a master slave relay routine to one development board (relay development board). 
            The project path is: ble_central\central_relay_1m2s\MDK-ARM\central_relay.uvprojx.
...
6. Download slave routines to another development board (slave development board). Project path:
    ...
    Use the default Bluetooth MAC address: "x0C x02 x03 x04 x05 x07", change the ble name is not same as "NS_RDTSS".
...
4. Process description:
    ...
    When the relay is connected to the 2 master devices, the broadcast stops; When the relay is disconnected 
