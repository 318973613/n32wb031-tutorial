...
/* Device name */
#define CUSTOM_DEVICE_NAME                  "NS_HID_CLIENT"                            /**<The device name of this device*/
...
#define SEC_PARAM_IKEY                      (GAP_KDIST_ENCKEY|GAP_KDIST_IDKEY)          /**< Initiator Key Distribution. (@enum gap_kdist) */
#define SEC_PARAM_RKEY                      (GAP_KDIST_ENCKEY|GAP_KDIST_IDKEY)          /**< Responder Key Distribution. (@enum gap_kdist) */
...
#define CACHE_DATA_BASE_ADDR                0x0103C000
